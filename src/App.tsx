...
export default function App() {
  ...
  const products = [
    {
      name: 'Ampris',
      desc: 'Power and Electrical SCADA for utilities, substations, and energy management.',
      icon: Zap,
    ...
    {
      name: 'FlowNexus',
      desc: 'Flow and liquid monitoring for pipelines, water treatment, and fluid systems.',
      icon: Droplets,
    ...
    {
      name: 'NexaProc',
      desc: 'Factory and process automation SCADA for manufacturing and industrial plants.',
      icon: Factory,
    ...
    <div className="min-h-screen bg-white text-gray-900 font-sans">
      ...
      <nav className="fixed top-0 w-full z-50 bg-white/95 backdrop-blur border-b border-gray-100 shadow-sm">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xl font-black tracking-widest text-gray-900">GALVON</span>
          </div>
          <div className="hidden md:flex items-center gap-8 text-sm text-gray-600">
            ...
            <a href="#contact" className="bg-blue-600 text-white px-5 py-2 rounded-lg hover:bg-blue-700 transition-colors font-semibold">Request Demo</a>
          </div>
        ...
        {menuOpen && (
          <div className="md:hidden px-6 pb-4 flex flex-col gap-4 text-sm text-gray-600 border-t border-gray-100 pt-4">
            ...
            <a href="#contact" className="bg-blue-600 text-white px-4 py-2 rounded-lg text-center font-semibold" onClick={() => setMenuOpen(false)}>Request Demo</a>
          </div>
        )}
      </nav>

      {/* Hero */}
      <section className="relative min-h-screen flex items-center justify-center pt-20 bg-gradient-to-br from-slate-50 via-blue-50/40 to-white">
        ...
        <div className="relative z-10 text-center px-6 max-w-5xl mx-auto">
          ...
          <h1 className="text-6xl md:text-8xl font-black tracking-widest text-gray-900 mb-6">
            GAL<span className="text-blue-600">VON</span>
          </h1>
          <p className="text-xl md:text-2xl text-gray-600 mb-4 max-w-2xl mx-auto leading-relaxed">{heroSub}</p>
          <p className="text-gray-400 mb-10 text-sm">Powering Ampris, FlowNexus, and NexaProc</p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="#products" className="flex items-center justify-center gap-2 bg-blue-600 text-white px-8 py-3 rounded-xl font-semibold hover:bg-blue-700 transition-colors shadow-lg shadow-blue-200">
              Explore Products <ArrowRight size={18} />
            </a>
            <a href="#contact" className="flex items-center justify-center gap-2 border border-gray-200 text-gray-700 px-8 py-3 rounded-xl font-semibold hover:bg-gray-50 transition-colors">
              Request Demo
            </a>
          </div>
      ...
      <section id="products" className="py-24 px-6 max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-gray-900 mb-4">The Galvon Suite</h2>
          <p className="text-gray-500 max-w-xl mx-auto">Three specialized SCADA platforms, unified under one industrial intelligence ecosystem.</p>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {products.map((p) => (
            <div key={p.name} className={`border-2 rounded-2xl p-8 hover:shadow-lg transition-all duration-300 group ${p.accent}`}>
              ...
              <button className="flex items-center gap-2 text-sm font-semibold text-current group-hover:gap-3 transition-all">
      ...
      <section id="features" className="py-24 px-6 bg-slate-50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Why Galvon</h2>
            <p className="text-gray-500 max-w-xl mx-auto">Built from the ground up for industrial environments where failure is not an option.</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {features.map((f) => (
              <div key={f.title} className="bg-white border border-gray-100 rounded-2xl p-6 hover:shadow-md transition-all">
      ...
      <section id="industries" className="py-24 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-500">Galvon powers industrial operations across sectors.</p>
          </div>
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
            {industries.map((ind) => (
              <div key={ind.label} className="flex flex-col items-center gap-3 bg-white border border-gray-100 rounded-xl p-5 hover:border-blue-200 hover:shadow-md transition-all">
                <ind.icon className="text-blue-600" size={28} />
      ...
      <section id="contact" className="py-24 px-6 bg-slate-50">
        <div className="max-w-3xl mx-auto text-center">
          <div className="bg-white border border-blue-100 rounded-3xl p-12 shadow-xl shadow-blue-50">
            <CheckCircle className="text-blue-600 mx-auto mb-6" size={40} />
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Ready to digitize your plant?</h2>
            <p className="text-gray-500 mb-8">Talk to our industrial automation experts. Get a live demo tailored to your industry.</p>
            <a href="mailto:hello@galvon.com" className="inline-flex items-center gap-2 bg-blue-600 text-white px-8 py-3 rounded-xl font-semibold hover:bg-blue-700 transition-colors shadow-lg shadow-blue-200">
      ...
      <footer className="border-t border-gray-100 py-10 px-6 bg-white">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2">
            ...
            <span className="text-lg font-black tracking-widest text-gray-900">GALVON</span>
          </div>
          ...
          <div className="text-center md:text-right">
            ...
            <div className="text-gray-400 text-xs mt-1">v{VERSION} | {BUILD_DATE} | galvon</div>
          </div>
        </div>
      </footer>
    </div>
